  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow p-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-4">Koç Paneli - Genel Bakış</h1>
        <p className="text-gray-600">Koç paneline hoş geldiniz. Buradan öğrencilerinizin genel durumunu takip edebilirsiniz.</p>
      </div>
